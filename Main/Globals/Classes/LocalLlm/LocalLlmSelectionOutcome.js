...
/**
 * LocalLlmSelectionOutcome
 *
 * What LocalLlmModelSelector decided, and why. Either a catalogue model key
 ...
 */
class LocalLlmSelectionOutcome
{
    #modelKey = null;
    #preferredModelKey = null;
    #bDegraded = false;
    #unavailableReason = localLlmUnavailableReasons.NONE;
    #degradeNote = null;

    constructor({ modelKey = null, preferredModelKey = null, unavailableReason = localLlmUnavailableReasons.NONE, degradeNote = null } = {})
    {
...
export default LocalLlmSelectionOutcome;
