 ...
 *                      Razorpay checkout opens (mirroring the existing
        ...
        return new Promise((resolve) =>
        {
            ...
            createButton.addEventListener("click", async () =>
            {
                ...
                try
                {
                    ...
                    // Razorpay path — open the checkout exactly as the
                    ...
                    ({
                        ...
                        handler: async (paymentResult) =>
                        {
                            try
                            {
                                ...
                                {
                                    await DialogBox.alert("Payment captured but verify failed", "Razorpay says the payment succeeded; our verification call did not. The webhook will reconcile this within a few seconds — refresh the list to confirm.");
                                }
                            }
                            catch (verifyError)
                            {
