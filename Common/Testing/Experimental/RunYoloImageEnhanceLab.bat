@echo off
REM Launches the YOLO + Image-Enhance experimentation harness using the Agent's
REM virtualenv (which already has fitz, doclayout-yolo, google-genai, imagehash,
...
"%VENV_PYTHON%" "%SCRIPT_DIR%YoloImageEnhanceLab.py"
