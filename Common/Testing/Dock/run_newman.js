// Builds the CogniumLearn Postman collection (data-driven from the endpoint tables
// below), writes it to CogniumLearn.postman_collection.json so it is openable in
...
const COLLECTION_PATH = path.join(__dirname, "CogniumLearn.postman_collection.json");
...
function buildCollection()
{
    ...
    return {
        info: {
            name: "CogniumLearn API & Auth Isolation",
