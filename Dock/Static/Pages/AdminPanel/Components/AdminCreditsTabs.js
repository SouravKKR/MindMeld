...
import PromoCodesPanel from "./PromoCodesPanel.js";
...
class AdminCreditsTabs extends HTMLElement
{
    ...
    connectedCallback()
    {
        ...
        this.#promoCodesPanelElement = document.createElement("promo-codes-panel");
        panelsContainer.appendChild(this.#grantPanelElement);
        panelsContainer.appendChild(this.#configEditorElement);
        panelsContainer.appendChild(this.#promoCodesPanelElement);
    ...
    #applyActiveSection()
    {
        ...
        const isPromoSection = this.#activeSection === creditAdminSections.PROMO_CODES;
        const isConfigSection = !isGrantsSection && !isPromoSection;

        this.#grantPanelElement.style.display = isGrantsSection ? "" : "none";
        this.#promoCodesPanelElement.style.display = isPromoSection ? "" : "none";
        this.#configEditorElement.style.display = isConfigSection ? "" : "none";
