...
class MockTestAnswerKeyPdfBuilder
{
    ...
    static #buildDocument(mockTest)
    {
        ...
        for (const item of items)
        {
            ...
            else if (itemType === mockTestItemTypes.QUESTION)
            {
                ...
                cursorY = MockTestAnswerKeyPdfBuilder.#renderQuestion(document, item, runningQuestionNumber, pageMargin, contentWidth, cursorY, guardSpace, writeText);
            }
        }
    ...
    static #renderQuestion(document, questionItem, questionNumber, pageMargin, contentWidth, cursorY, guardSpace, writeText)
    {
