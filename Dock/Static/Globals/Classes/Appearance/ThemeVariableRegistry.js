...
class ThemeVariableRegistry
{
    ...
    [
        ...
        { name: "--status-success",              label: "Status Success",        group: "Semantic",    type: "color",    defaultValue: "#00C482" },
        { name: "--status-in-progress",          label: "Status In Progress",    group: "Semantic",    type: "color",    defaultValue: "#0098C4" },
        { name: "--status-failed",               label: "Status Failed",         group: "Semantic",    type: "color",    defaultValue: "#DC5050" },
