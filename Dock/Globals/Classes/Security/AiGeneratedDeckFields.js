 ...
 * generation pipeline. Mirrors the canonical definition in
 * Main/Globals/Classes/Security/AiGeneratedDeckFields.js. Dock keeps a local
 * copy so the generation pipeline, the sync floor and the query engines never
 * sprinkle string literals when stamping or filtering by it. The value is the
 * literal property name that Mongo and the sync layer see.
 *
...
module.exports = AiGeneratedDeckFields;
