...
class LogTitles
{
    ...
    static ACCOUNT_IDENTITY_SPLIT_DETECTED = "ACCOUNT_IDENTITY_SPLIT_DETECTED";
    static ACCOUNT_MERGE_COMPLETED = "ACCOUNT_MERGE_COMPLETED";
    static ACCOUNT_MERGE_FAILED = "ACCOUNT_MERGE_FAILED";
