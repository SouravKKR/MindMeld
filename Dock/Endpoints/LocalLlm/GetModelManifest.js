 ...
 * Common/Constants/LocalLlmModelCatalogue.json; this endpoint only reports
 ...
 *         `node Common/Scripts/ProvisionLocalLlmModels.js`. The frontend
...
class GetModelManifestEndpoint
{
    ...
    static async handle(request, response)
    {
        ...
        const describedModels = LocalLlmModelRegistry.describeModels(assetsDirectory);
        ...
        response.sendJson(
        {
            ...
            runtimeBaseUrl: LocalLlmDownloadConstants.RUNTIME_ASSETS_BASE_PATH,
